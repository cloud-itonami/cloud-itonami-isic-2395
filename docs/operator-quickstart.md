# Operator Quickstart — Manufacture of articles of concrete, cement and plaster

Shortest path from clone to a verified local dry-run for **ISIC 2395** (`cloud-itonami-isic-2395`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2395.git
cd cloud-itonami-isic-2395
```
...
- Blueprint governor key: `concrete-plant-operations-governor`
- Likely source path: `concretemfg.governor.cljc`

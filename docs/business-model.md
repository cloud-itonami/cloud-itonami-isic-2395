# Business Model: Manufacture of articles of concrete, cement and plaster
...
## Classification
- Repository: `cloud-itonami-isic-2395` ([github.com/cloud-itonami/cloud-itonami-isic-2395](https://github.com/cloud-itonami/cloud-itonami-isic-2395))
- ISIC Rev.5: `2395` — Manufacture of articles of concrete, cement and plaster
- Domain: `:concrete-cement-plaster-products/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:concrete-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :concrete-cement-plaster-products/manufacturing — who wants
...
One managed tenant (:concrete-cement-plaster-products/manufacturing):
...
- Do not bypass the `:concrete-plant-operations-governor` for production decisions.

(ns concretemfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [concretemfg.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [g [:precast-concrete-panel :concrete-pipe :concrete-masonry-block
...
(deftest fabricated-product-type-is-invalid
  (is (not (r/product-type-valid? :unobtainium-slab)))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "batcher-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "batcher-001" 1)

(ns concretemfg.phase
  "Phase 0->3 staged rollout for the concrete/cement/plaster products
  ...
  consequence (a mixing/batching-plant or molding-line-equipment
  ...
  `concretemfg.governor`'s `mixing-line-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Concrete Plant Operations Governor verdict to a base
